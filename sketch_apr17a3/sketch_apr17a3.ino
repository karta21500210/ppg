    ...
    if ( ir_out_ok >= 2 and red_out_ok >= 2)
    {
      ...
      if (output_flag >= output_length)
      {
        ...
        for (item = 0; item < output_length; item++)
        {
          ...
          {
            if (irsibuffer[item] > irtopbuffer[item] and float(-irtopbuffer[item] + irsibuffer[item]) <= 23)
            {
          ...
          {
            if (redtopbuffer[item] < redsibuffer[item] and float(-redtopbuffer[item] + redsibuffer[item]) <= 23)
            {
